 ...
 */
    ...
    // name
    AppMain(int length, String newDomain) {
        this();
    ...
    public static void main(String args[]) {
        AppMain u = new AppMain(5, "www.meli.com/");
        Scanner miURL = new Scanner(System.in);  // Creé un objeto para recibir y guardar la URL del usuario
        System.out.println("Ingresa una URL por favor");

        String miniURL = miURL.nextLine();  // Acá le digo al sistema que lea no que escribió el usuario y lo guarde en la variable miniURL
        System.out.println("La URL corta es: " + u.shortenURL(miniURL));  // Acá imprimo la URL corta del usuario pasando miniURL por la función shortenURL de arriba
        System.out.println("La URL larga es: " + u.expandURL(u.shortenURL(miniURL)));
